...
strategy=Strategy.query.filter_by(name="openning_range_breakout").first()
...
# Use this when we are geting minute bars from the current day
...
for symbol in symbols:
    minute_bars=api.get_bars_iter(symbol, TimeFrame(1, TimeFrameUnit.Minute), "2022-03-15", "2022-03-15")
